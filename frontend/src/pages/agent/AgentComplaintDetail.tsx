      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-3xl shadow-sm border border-stone-200 p-8 sticky top-24">
            <h3 className="text-xl font-extrabold text-slate-800 mb-6">Actions</h3>
            <div className="mb-8">
              <label htmlFor="status" className="block text-sm font-bold text-slate-700 mb-3">
                Changer le statut
              </label>
              <select
                id="status"
            ...
            <form onSubmit={handleAddNote}>
              <label htmlFor="note" className="block text-sm font-bold text-slate-700 mb-3">
                Ajouter une note / Répondre
              </label>
              <textarea
                id="note"
                rows={5}
