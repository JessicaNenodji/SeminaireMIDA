-- Schéma relationnel conforme au diagramme de classes du système de gestion des plaintes
...
SELECT id, username, email, password, role, nom
FROM utilisateur;
...
CREATE TABLE IF NOT EXISTS citoyen (
    ...
    CONSTRAINT fk_citoyen_utilisateur FOREIGN KEY (utilisateur_id) REFERENCES utilisateur(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS agent (
    ...
    PRIMARY KEY (utilisateur_id),
    CONSTRAINT fk_agent_utilisateur FOREIGN KEY (utilisateur_id) REFERENCES utilisateur(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS plainte (
    ...
    CONSTRAINT fk_plainte_categorie FOREIGN KEY (categorie_id) REFERENCES categorie(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS piece_jointe (
    ...
    CONSTRAINT fk_piece_jointe_plainte FOREIGN KEY (plainte_id) REFERENCES plainte(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS audit_log (
    ...
    CONSTRAINT fk_audit_log_plainte FOREIGN KEY (plainte_id) REFERENCES plainte(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
